...
class ViewController: UIViewController {
    ...
    func alert(title: String, message: String, style: UIAlertController.Style){
        ...
        alertControler.addTextField{ (textFields1) in
        }
        alertControler.addTextField{ (textFields2) in
        }
    ...
    func alertName(title: String, message: String, style: UIAlertController.Style){
        ...
        alertControler2.addTextField{ (textFields1) in
        }
    ...
    func guessNumber(title: String, message: String, style: UIAlertController.Style){
        ...
        alertControler3.addTextField{ (textFields1) in
        }
